...
**Пример набора преобразований в форме цепочки для cos²(x) = sin(2x). НЕ пиши цепочки, а только отдельные преобразования:**
...
**Пример ПРАВИЛЬНЫХ независимых преобразований для cos²(x) = sin(2x):**
✅ (1) \frac{1}{2}cos²(x) = \frac{1}{2}\sin(2x)              // разделить обе части на 2
✅ (2) cos²(x) = 2sin(x)cos(x)         // применить известное тождество sin(2x) = 2sin(x)cos(x)
✅ (3) 1 - sin²(x) = sin(2x)           // применить известное тождество cos²(x) = 1 - sin²(x)
✅ (4) cos²(x) = sin(2x)cos(x)         // умножить обе части на cos(x)
✅ (5) cos²(x) + 1 = sin(2x) + 1       // прибавить 1 к обеим частям
✅ (6) \frac{cos²(x)}{cos(x)} = \frac{sin(2x)}{cos(x)}         // разделить обе части на cos(x)
✅ (7) cos²(\sqrt{x^2}) = sin(2x)       // заменить в левой части x на \sqrt{x^2}
✅ (8) cos²(y/2) = sin(2 y/2)           // заменить x на y/2
✅ (9) cos²(x) = sin(x + x)             // представить 2x как x + x
✅ (10) \frac{4cos²(x)}{4} = sin(2x)    // разделить и домножить левую часть на 4
