...
from core.types import (
    SolutionStep, SolutionType, SolutionBranch,
    create_solution_step, create_system_step, 
    create_cases_step, create_alternatives_step
)
...
def test_alternatives_step_creation():
    ...
    step = create_alternatives_step("Решение квадратного уравнения x² + x - 6 = 0", alternatives)
