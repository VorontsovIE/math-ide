...
def test_basic_rollback():
    ...
    history.add_step(
        ...
        chosen_transformation={"description": "Вычесть 1", "type": "subtract", "expression": "x = 2"},
    ...
    history.add_step(
        expression="x = 2",
        available_transformations=[],
        chosen_transformation={"description": "Решение найдено", "type": "solution", "expression": "x = 2"},
        result_expression="x = 2"
    )
    ...
    history.add_step(
        expression="x = 2",
        available_transformations=[],
        chosen_transformation={"description": "Проверка", "type": "verify", "expression": "2 + 1 = 3"},
...
def test_rollback_to_first_step():
    ...
    history.add_step(
        expression="2x = 4",
        available_transformations=[],
        chosen_transformation={"description": "Разделить на 2", "type": "divide", "expression": "x = 2"},
        result_expression="x = 2"
    )
...
def test_can_rollback():
    ...
    history.add_step(
        expression="x = 0",
        available_transformations=[],
        chosen_transformation={"description": "Решение", "type": "solution", "expression": "x = 0"},
...
def test_rollback_by_id():
    ...
    step1_id = history.add_step(
        expression="3x = 9",
        available_transformations=[],
        chosen_transformation={"description": "Разделить на 3", "type": "divide", "expression": "x = 3"},
    ...
    step2_id = history.add_step(
        expression="x = 3",
        available_transformations=[],
        chosen_transformation={"description": "Готово", "type": "solution", "expression": "x = 3"},
        result_expression="x = 3"
    )
    ...
    step3_id = history.add_step(
        expression="x = 3",
        available_transformations=[],
        chosen_transformation={"description": "Проверка", "type": "verify", "expression": "3*3 = 9"},
...
def test_get_current_expression():
    ...
    history.add_step(
        expression="x + 5 = 7",
        available_transformations=[],
        chosen_transformation={"description": "Вычесть 5", "type": "subtract", "expression": "x = 2"},
        result_expression="x = 2"
    )
    assert history.get_current_expression() == "x = 2"
...
def test_rollback_and_continue():
    ...
    history.add_step(
        expression="2x + 4 = 8",
        available_transformations=[],
        chosen_transformation={"description": "Вычесть 4", "type": "subtract", "expression": "2x = 4"},
    ...
    new_step_id = history.add_step(
        expression="2x + 4 = 8",
        available_transformations=[],
        chosen_transformation={"description": "Разделить все на 2", "type": "divide", "expression": "x + 2 = 4"},
