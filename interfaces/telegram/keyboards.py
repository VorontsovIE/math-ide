...
def get_transformations_keyboard(
    transformations: "List[Transformation]", step_id: Optional[str] = None
    ...
    keyboard.append(
        [
            InlineKeyboardButton(
                "✏️ Ввести своё преобразование", callback_data=custom_callback_data
            )
        ]
    )
...
def get_verification_keyboard(
    ...
    keyboard = [
        [
            InlineKeyboardButton(
                "🔄 Пересчитать (есть ошибка)", callback_data="verify_recalculate"
            )
        ],
        [
            InlineKeyboardButton(
                "💡 Предложить свой результат", callback_data="verify_suggest"
            )
        ],
        [
            InlineKeyboardButton(
                "✅ Результат правильный", callback_data="verify_accept"
            )
        ],
    ]
    return InlineKeyboardMarkup(keyboard)
