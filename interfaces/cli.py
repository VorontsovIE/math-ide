    ...
    try:
        ...
        while True:
            try:
                ...
                if input_handler.confirm_action("Показать текущее решение перед выходом?"):
                    solution_processor.show_solution_summary()
                break
    ...
    try:
        ...
        while step_count < max_steps:
            ...
            if best_transformation.requires_user_input:
                display_manager.show_info(f"Пропуск параметризованной трансформации: {best_transformation.description}")
